...
export const INITIAL_RELATED_DOCS: RelatedDoc[] = [
    { id: "r1", docId: "001/2026/TT-BCA", title: "Góp ý dự thảo Quy chế quản lý, vận hành khai thác mạng viễn thông...", sender: "Cục quản lý đầu thầu", isUrgent: false },
];
...
export const SELECT_OPTIONS: Record<string, string[]> = {
    ...
    department: ["Phòng Hành chính tổng hợp", "Phòng Kế hoạch - Tài chính", "Phòng Công nghệ thông tin", "Phòng Pháp chế", "Phòng Tổ chức cán bộ", "Trung tâm Đấu thầu qua mạng quốc gia - Phòng Hành chính tổng hợp", "Ban Giám đốc"],
